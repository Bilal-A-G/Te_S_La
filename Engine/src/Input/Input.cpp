...
{
    if(glfwGetKey(window, keycode) == GLFW_PRESS && !ImGui::GetIO().WantCaptureKeyboard)
    {
...
{
    if(glfwGetKey(window, keycode) == GLFW_RELEASE && !ImGui::GetIO().WantCaptureKeyboard)
    {
...
{
    if(glfwGetMouseButton(window, keycode) == GLFW_PRESS && !ImGui::GetIO().WantCaptureMouse)
    {
...
{
    if(glfwGetMouseButton(window, keycode) == GLFW_RELEASE && !ImGui::GetIO().WantCaptureMouse)
    {
